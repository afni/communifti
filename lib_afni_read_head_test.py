...
# A library of testing functions for evaluating lib_afni_read_head.py.
#
# Basically, we compare with what '3dAttribute -all ...' would output,
# taking that as (mostly) the right answer.
#
#   ** To use functionality in this file, you must have AFNI installed **
#
...
if __name__ == "__main__" :
    ...
    inset   = '~/AFNI_data6/FT_analysis/FT/FT_anat+orig.HEAD'
    rep_3dA = '~/AFNI_data6/FT_analysis/FT/report_01_3dA.txt'
    rep_lrh = '~/AFNI_data6/FT_analysis/FT/report_01_lrh.txt'
    diff_01 = '~/AFNI_data6/FT_analysis/FT/DIFF_01.txt'
