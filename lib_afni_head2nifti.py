...
# consideration from the point of view of mapping AFNI *.HEAD file
# attributes.
...
is_fail : int
    0 on success, nonzero on failure
mri_type : int
    int corresponding to string name of MRI_TYPE in AFNI
nifti_datatype : int
    integer code of NIFTI type, from nifti_datatype_list in nifti1_io.c
nifti_bitpix : int
    bitpix value of NIFTI type, from nifti_datatype_list in nifti1_io.c
    ...
    if mri_type_name == "MRI_byte" :
        nifti_datatype = lnd.DICT_nifti_datatype["NIFTI_TYPE_UINT8"]
        nifti_bitpix   = lnd.DICT_nifti_bitpix["NIFTI_TYPE_UINT8"]
    elif mri_type_name == "MRI_short" :
        nifti_datatype = lnd.DICT_nifti_datatype["NIFTI_TYPE_INT16"]
        nifti_bitpix   = lnd.DICT_nifti_bitpix["NIFTI_TYPE_INT16"]
    elif mri_type_name == "MRI_int" :
        nifti_datatype = lnd.DICT_nifti_datatype["NIFTI_TYPE_INT32"]
        nifti_bitpix   = lnd.DICT_nifti_bitpix["NIFTI_TYPE_INT32"]
    elif mri_type_name == "MRI_float" :
        nifti_datatype = lnd.DICT_nifti_datatype["NIFTI_TYPE_FLOAT32"]
        nifti_bitpix   = lnd.DICT_nifti_bitpix["NIFTI_TYPE_FLOAT32"]
    elif mri_type_name == "MRI_double" :
        nifti_datatype = lnd.DICT_nifti_datatype["NIFTI_TYPE_FLOAT64"]
        nifti_bitpix   = lnd.DICT_nifti_bitpix["NIFTI_TYPE_FLOAT64"]
    elif mri_type_name == "MRI_complex" :
        nifti_datatype = lnd.DICT_nifti_datatype["NIFTI_TYPE_COMPLEX64"]
        nifti_bitpix   = lnd.DICT_nifti_bitpix["NIFTI_TYPE_COMPLEX64"]
    elif mri_type_name == "MRI_rgb" :
        nifti_datatype = lnd.DICT_nifti_datatype["NIFTI_TYPE_RGB24"]
        nifti_bitpix   = lnd.DICT_nifti_bitpix["NIFTI_TYPE_RGB24"]
    ...
    return 0, mri_type_name, nifti_datatype, nifti_bitpix
