...
# ============================================================================
# 
# A library file for testing the BRIK/HEAD -> NIFTI conversion functionality.
#
...
from .      import lib_afni_head2nifti as lah2n
...
ALL_nifti1_keys = lnd.dict_nifti1.keys()
...
Cdict_diffs : dict
    ...
    is_fail2, NdictA = lah2n.make_nifti_header_from_brik( fname, verb=verb )
