...
# ============================================================================
# 
# A library file for read AFNI-format *.HEAD files.
#
...
if __name__ == "__main__" :
    ...
    x = HeadFile('~/AFNI_data6/FT_analysis/FT/FT_anat+orig.HEAD')
    x.write_report('~/AFNI_data6/FT_analysis/FT/report_py_head.txt')
